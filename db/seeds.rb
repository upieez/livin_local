...
hawpar_villa = Place.create(:name => "Haw Par Villa", :description => "Haw Par Villa (Chinese: 虎豹別墅; pinyin: Hǔ Bào Biéshù) is a theme park located along Pasir Panjang Road in Singapore. The park contains over 1,000 statues and 150 giant dioramas depicting scenes from Chinese mythology, folklore, legends, history, and illustrations of various aspects of Confucianism.", :img_url => "https://media.timeout.com/images/103787766/630/472/image.jpg", :address => "262 Pasir Panjang Rd, Singapore 118628", :user_id => 1, :approval => true)


lorong_buangkok = Place.create(:name => "Lorong Buangkok Kampong", :description => "Kampong Lorong Buangkok is a village located in Buangkok in Hougang, Singapore. Built in 1956, it is the last surviving kampong located on Singapore Island in the 21st century. A wide canal ran alongside the kampong, which links to Sungei Punggol that drains into the eastern Straits of Johor.", :img_url => "https://upload.wikimedia.org/wikipedia/commons/2/2e/The_Winding_Lanes_of_KB.JPG", :address => "Buangkok in Hougang", :user_id => 2, :approval => true)


pulau_ubin = Place.create(:name => "Pulau Ubin", :description => "Pulau means 'island', and Ubin is said to be a Javanese term for 'squared stone'. To the Malays, the island is also known as Pulau Batu Ubin, or 'Granite Stone Island'. The rocks on the island were used to make floor tiles in the past and were called Jubin, which was then shortened to Ubin.", :img_url => "https://lonelyplanetimages.imgix.net/a/g/hi/t/9911da3333065d1261ac78d69499f9d3-pulau-ubin.jpg", :address => "Northeast Region", :user_id => 3, :approval => true)


punggol_busstop = Place.create(:name => "Old Bus Stop at Punggol", :description => "This nostalgic sight is conserved by the National Parks Board. Buses no longer stop here, but it remains as a cool rest stop that is perfect for photos! This is a short walk away from Punggol Road, near the centre portion of the Waterway. If you love heritage trails, take a look at the Punggol Discovery Route!", :img_url => "https://mynicehome.sg/cs/Satellite?blobcol=urldata&blobkey=id&blobtable=MungoBlobs&blobwhere=1383607934471&ssbinary=true", :address => "Old Punggol Road", :user_id => 4, :approval => true)
