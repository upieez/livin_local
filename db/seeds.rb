...
#################################### PLACES_TAGS ####################################
# THIS DOES NOT WORK
# a = Places_Tags.create(:place_id => 1, :tag_id => 7)
# b = Places_Tags.create(:place_id => 5, :tag_id => 7)
# c = Places_Tags.create(:place_id => 6, :tag_id => 10)
# d = Places_Tags.create(:place_id => 7, :tag_id => 10)
